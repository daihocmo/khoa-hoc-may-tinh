...
- Các quy tắc đếm cơ bản: [Các quy tắc đếm cơ bản - Trường THPT chuyên Hà Nội - Amsterdam](https://hnams.edu.vn/data/uploads/files/Toan/Toan%252011/Toan%252011%2520NC/Chuong%25202/Bai%25201/Cac%2520quy%2520tac%2520dem%2520co%2520ban.pdf)
- Xác suất: [Chương 4: Xác suất - Tài liệu học tập](https://voer.edu.vn/m/chuong-4-xac-suat-e8139)
- Hoán vị & Tổ hợp: [Hoán vị - Chỉnh hợp - Tổ hợp - ToanMath.vn](https://toanmath.vn/hoan-vi-chinh-hop-to-hop/)
- Lý thuyết đồ thị: [Chương 1: Các khái niệm cơ bản về lý thuyết đồ thị - Tài liệu Bách Khoa](https://tailieubk.com/2016/10/chuong-1-cac-khai-niem-co-ban-ve-ly-thuyet-do-thi/)
...
- **Arrays:** [Mảng (Array) trong C++ và ứng dụng](https://viblo.asia/p/mang-array-trong-c-va-ung-dung-naQjzvYkZWA)
- **Linked Lists:** [LinkedList trong Java và các thao tác cơ bản](https://viblo.asia/p/linkedlist-trong-java-va-cac-thao-tac-co-ban-dje5Vj99lWj)
...
- AVL trees: [Cây AVL - Lý thuyết và cài đặt](https://freetuts.net/cay-avl-ly-thuyet-va-cai-dat-1027.html)
...
- **Hash Tables:** [Tìm hiểu về cấu trúc dữ liệu HashTable](https://viblo.asia/p/tim-hieu-ve-cau-truc-du-lieu-hashtable-dje5Vj99lWj)
- **Sets:** [Set trong C++](https://viblo.asia/p/set-trong-c-YOWZnVw8KQ0)
...
- Adjacency matrix and adjacency list representation: [Biểu diễn đồ thị trong C++ (Adjacency Matrix và Adjacency List)](https://viblo.asia/p/bieu-dien-do-thi-trong-c-adjacency-matrix-va-adjacency-list-dje5Vj99lWj)
...
- Linear Search: [Thuật toán tìm kiếm tuyến tính (Linear Search) trong C++](https://viblo.asia/p/thuat-toan-tim-kiem-tuyen-tinh-linear-search-trong-c-YbJlXJ7elWj)
- Binary Search: [Thuật toán tìm kiếm nhị phân (Binary Search)](https://viblo.asia/p/thuat-toan-tim-kiem-nhi-phan-binary-search-Eb85oVy6l2G)
- Interpolation Search: [Tìm kiếm nội suy (Interpolation Search)](https://freetuts.net/tim-kiem-noi-suy-interpolation-search-2840.html)
- Các thuật toán tìm kiếm nâng cao (Ternary Search, Exponential Search):
  - **Ternary Search:** [Tìm kiếm tam phân (Ternary Search)](https://freetuts.net/tim-kiem-tam-phan-ternary-search-2841.html)
...
- Topological Sort: [Thuật toán sắp xếp Topo (Topological Sort)](https://viblo.asia/p/thuat-toan-sap-xep-topo-topological-sort-dje5Vj99lWj)
- Strongly Connected Components (Tarjan's algorithm): [Thuật toán Tarjan tìm các thành phần liên thông mạnh](https://vnoi.info/wiki/algo/graph/tarjan-scc)
- Maximum Flow (Ford-Fulkerson algorithm): [Bài toán luồng cực đại và thuật toán Ford-Fulkerson](https://vnoi.info/wiki/algo/graph/max-flow)

### Dynamic Programming:

- Memoization and tabulation: [Memoization và Tabulation trong Dynamic Programming](https://viblo.asia/p/memoization-va-tabulation-trong-dynamic-programming-naQjzvYkZWA)
...
- **Backtracking:** [Thuật toán Backtracking (quay lui) và ứng dụng](https://viblo.asia/p/thuat-toan-backtracking-quay-lui-va-ung-dung-naQjzvYkZWA)

### 4. Greedy Algorithms:

- Activity Selection Problem, Huffman Coding, Fractional Knapsack Problem
- **Greedy Algorithms:** [Thuật toán tham lam (Greedy Algorithm)](https://viblo.asia/p/thuat-toan-tham-lam-greedy-algorithm-naQjzvYkZWA)
